...
<head>
    ...
    <div id="page">
      ...
      <div id="nav">
        <ul>
          <li>
            <a href="<c:url value="/newappointment" />">New Appointment</a>
          </li>
          <li>
            <a href="<c:url value="/cancelappointment" />">Cancel Appointment</a>
          </li>
          <li>
            <a href="<c:url value="/myappointments" />">Show Appointments</a>
          </li>
        </ul>
